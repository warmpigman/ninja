                        ...
                        if (res.data.player.socialMedia.links.DISCORD) {
                            if (message.author.tag ==
                                ...
                                await message.guild.roles.fetch().then(async (roles) => {
                                    let tradeBannedRole = roles.find((r) => r.name.toLowerCase() === "trade banned");
                                    if (message.member.roles.cache.has(tradeBannedRole.id)) {
                                        ...
                                        if (tradeVerifiedRole) {
                                            try {
                                                ...
                                                embed.addFields({
                                                    name: "Error!",
                                                    value: "I do not have sufficient permissions to add roles to you.",
                                                });
                                            }
                                        }
                                        else {
                                            embed.addFields({
                                                name: "Error!",
                                                value: "No trade verified role found, try again when one has been made.",
                                            });
                                        }
                                    }
