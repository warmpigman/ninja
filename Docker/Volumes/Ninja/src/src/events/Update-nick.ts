...
module.exports = {
    ...
    async execute(client: any, paguClient: any, oldMember: GuildMember, newMember: GuildMember) {
        ...
        if (badWords.some((word: { word: String }) => newMember.nickname?.toLowerCase().includes(word.word.toLowerCase()))) {
