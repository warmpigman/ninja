  ...
  bootstrapMetrics() {
    ...
    setInterval(() => {
      let metrics = {
        ...
        last_minute: Object.values(this.latestMinuteRequests).reduce((sum: any, current: any) => sum + current, 0),
        last_hour: Object.values(this.latestHourRequests).reduce((sum: any, current: any) => sum + current, 0),
      }
